package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class KohUpdateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function deserializeAs_KohUpdateMessage(input:ICustomDataInput) : void
      {
         ...
         var _allianceNbMembersLen:uint = uint(input.readUnsignedShort());
         ...
         var _allianceRoundWeigthLen:uint = uint(input.readUnsignedShort());
         ...
         var _allianceMatchScoreLen:uint = uint(input.readUnsignedShort());
         ...
         var _allianceMapWinnersLen:uint = uint(input.readUnsignedShort());
